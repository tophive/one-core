 ...
 * @version 1.6.16
 */
class One_EDD_SL_Plugin_Updater {
	...
	public function show_changelog() {
		...
		if( ! current_user_can( 'update_plugins' ) ) {
			wp_die( __( 'You do not have permission to install plugin updates', 'tophive-pro' ), __( 'Error', 'tophive-pro' ), array( 'response' => 403 ) );
		}
    ...
    public function set_version_info_cache( $value = '', $cache_key = '' ) {
        ...
        set_transient( $cache_key, $value, 5*HOUR_IN_SECONDS );
    }
